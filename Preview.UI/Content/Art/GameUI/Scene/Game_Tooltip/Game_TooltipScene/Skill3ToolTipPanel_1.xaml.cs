...
public partial class Skill3ToolTipPanel_1
{
	...
	public Skill3ToolTipPanel_1()
	{
		InitializeComponent();
#if DEVELOP
		OldSkill = Globals.GameData.Provider.GetTable<Skill3>()["Summoner_S1_1_BackStep"];
		DataContext = Globals.GameData.Provider.GetTable<Skill3>()["Summoner_S0_1_BackStep"];
#endif
	}
	#endregion
	...
	protected override void OnPreviewMouseDown(MouseButtonEventArgs e)
	{
		...
		DataContext = Globals.GameData.Provider.GetTable<Skill3>()[Clipboard.GetText()];
	}
